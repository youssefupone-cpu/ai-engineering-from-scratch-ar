...
3. هل ميزانية الحوسبة `edge` (<30 مليون معلمة) أو `serverless` (<80 مليون) أو `server_gpu` أو `batch`؟
## قرار
- Q1 == no -> **الدلالي**، بغض النظر عن Q2.
- Q1 == نعم وQ2 == المقدمة -> **مثال**.
- Q1 == نعم وQ2 == كل -> **بانوبتيك**.
## اختيارات الهندسة المعمارية
### الدلالية (مذكورة في الدرس 7)
