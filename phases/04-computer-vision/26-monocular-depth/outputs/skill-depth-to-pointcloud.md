...
- للتنبؤ من نموذج العمق النسبي، قم بتصدير NOT كمقياس؛ اسم ملف الإخراج البادئة مع `relative_` للإشارة إلى الاتفاقية.
...
- بالنسبة للمشاهد الكثيفة (> 1 مليون نقطة)، قم بتقديم معلمة عينة فرعية؛ ملفات PLY > 500 MB يصعب تحميلها في كل مكان.
