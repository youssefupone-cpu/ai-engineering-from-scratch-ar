...
- `domain`: صور طبيعية | طبي | القمر الصناعي | وثائق | صناعية | memes_social
- `expected_hardness`: سهل (فئات مميزة بصريًا) | متوسطة | صعب (اختلافات دقيقة)
## قواعد
### القوالب الأساسية (تتضمن دائمًا)
```
"a photo of a {}"
"a picture of a {}"
"an image of a {}"
...
### الوظائف الإضافية الخاصة بالمجال
...
- بالنسبة إلى `expected_hardness == hard`، أضف قوالب الفئات الفائقة؛ وبدونها تنهار الطبقات الدقيقة.
- لا تستخدم مطلقًا أكثر من 100 قالب لكل فصل؛ تناقص العائدات بعد حوالي 80.
- شاهد غلاف اسم الفئة: CLIP يتعامل مع "dog" و"Dog" بشكل مشابه ولكن "DOG" (كل الحروف الكبيرة) يتعامل بشكل أسوأ؛ تطبيع إلى أحرف صغيرة ما لم يكن اسم الفئة اسم علم.