...
## بروتوكول التشخيص
### 1. جمع تفاصيل الهندسة المعمارية
...
### 2. مطابقة الحرف الأول مع الهندسة المعمارية
...
**تنشيطات ReLU أو Leaky ReLU أو GELU:**
...
- طبقات التضمين: `Normal(0, 0.02)` هو اصطلاح GPT
**طبقات تلافيفية:**
...
ثم بعد تمريرة أمامية واحدة:```python
hooks = []
