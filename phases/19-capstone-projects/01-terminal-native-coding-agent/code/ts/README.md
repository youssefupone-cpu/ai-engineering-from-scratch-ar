...
أداة متعددة الملفات TypeScript لحلقة الخطة/الفعل/المراقبة الموضحة في
`../docs/en.md`. غير متصل، حتمية، صفر مكالمات الشبكة.
...
يؤكد المسار `npm start` غير التفاعلي على أن تقارير التقييم `passed=3
failed=0` وأن التشغيل المكتوب يتقارب مع خطة كاملة التنفيذ. أي الانجراف
فشل التشغيل.
