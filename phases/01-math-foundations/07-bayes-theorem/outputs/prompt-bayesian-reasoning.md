...
5. **Compute the evidence P(E).** Use the law of total probability: P(E) = P(E|H) * P(H) + P(E|not H) * P(not H)

6. **Apply Bayes' theorem.** P(H|E) = P(E|H) * P(H) / P(E) Show the full calculation with numbers substituted.
