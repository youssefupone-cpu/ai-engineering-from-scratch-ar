...
استخدم هذا القالب عند إنشاء درس جديد. انسخ بنية المجلد واملأ المحتوى.
...
- يجب أن يعمل الكود بدون أخطاء
- لا توجد تعليقات - يجب أن يكون الكود واضحًا بذاته
- استخدم اللغة المناسبة للموضوع
- قم بتضمين `requirements.txt` أو ما يعادله إذا كانت هناك تبعيات
- ابدأ بالبساطة، ثم قم ببناء التعقيد
- يجب أن يكون لكل وظيفة وفئة غرض واضح
